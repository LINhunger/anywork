Vue.component('myDialog2',
    {
        ...
        methods: {
            ...
            mousemove: function(e){
                ...
                this.mousePos.y = e.clientY + $(window).scrollTop();
                var maxX = document.documentElement.clientWidth -  this.dialogInstace.moveElement.offsetWidth ;
                var maxY = document.documentElement.clientHeight - this.dialogInstace.moveElement.offsetHeight + $(window).scrollTop() ;
...
$(window).scroll(function(){
    var scrollHeight = $(window).scrollTop();
    _al2.top = scrollHeight;
    _al2.style.width = my_width
    _al2.style.height = my_heigth
})

var my_width, my_heigth;
function my_alert2(str){
    _al2.show = true,
        _al2.info=str;
    if(arguments[1]) _al2.style.width = my_width = arguments[1]+"px";
    if(arguments[2]) _al2.style.height = my_heigth = arguments[2]+"px";
