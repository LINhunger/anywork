            ...
            while(entrys.hasMoreElements()){
                ...
                if(entry.isDirectory()){
                    ...
                    if(!file.exists()){
                        ...
                        FileUtils.copyFile(new File(""),new FileOutputStream(file));// TODO: 2016/11/22 in
                        log.debug("创建文件");
                    }else{
                        log.debug("文件已经存在");
                    }
...
//                        zos.flush();
    ...
    public static void main(String[] args) {
        ZipUtils.createZip("C:\\Users\\hunger\\Desktop\\1\\2","C:\\Users\\hunger\\Desktop\\1\\temp\\2.zip");
